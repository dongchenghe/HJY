	...
	<div style="background:#CCFFCC; width:100%">
        ...
        <div id="mian">
            <div class="top1">
                ...
                <div class="top1-2">
                	<ul class="topul">
                    	<li class="topli"><a href="Index">首页</a></li>
                    </ul>
                </div>
            </div>
            <div class="center">      
            	...
            	<c:choose> 
					...
					<c:otherwise>
					<div class="catbox">
						<form id="form1" action="Balance" method="get">			
						  <table id="cartTable">
						    <thead>
						      <tr>
						        <th><label>
						    ...
						    <tbody>
						    	<c:forEach items="${list_goods}" var="goods_and_count" varStatus="i">
						    		 <tr id="goods${goods_and_count.CART_ID}">
								        ...
								        <td class="goods">
								        	<a href="GoodsShow?goods_id=${goods_and_count.GOODS_ID}">
								        	<img src="${goods_and_count.IMG_SRC}/${goods_and_count.IMG}.png" alt=""/><span>${goods_and_count.NAME}</span></td>
								        	</a>
								        ...
								        <td class="operation"><a href="javascript:;" class="delete555">删除</a></td>
						     		</tr>
						    	</c:forEach>
						    </tbody>
						  </table>
